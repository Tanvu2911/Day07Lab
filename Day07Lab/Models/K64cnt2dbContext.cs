...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=CUTỄUGAMING\\SQLEXPRESS;Database=K64CNT2DB;Trusted_Connection=True;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CtHoaDon>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CT_HOA_D__3214EC27A979969F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HOA_DON__3214EC27430DCD5F");

            entity.ToTable("HOA_DON");

            entity.HasIndex(e => e.MaHoaDon, "UQ__HOA_DON__835ED13A183CF776").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__KHACH_HA__3214EC27251D7FDA");

            entity.ToTable("KHACH_HANG");

            entity.HasIndex(e => e.DienThoai, "UQ__KHACH_HA__1F031876263C2413").IsUnique();

            entity.HasIndex(e => e.MaKhachHang, "UQ__KHACH_HA__88D2F0E4D2327BC9").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__KHACH_HA__A9D10534097F2934").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LOAI_SAN__3214EC271DB1687D");

            entity.ToTable("LOAI_SAN_PHAM");

            entity.HasIndex(e => e.MaLoai, "UQ__LOAI_SAN__730A5758F38B2D85").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__QUAN_TRI__3214EC2772291504");

            entity.ToTable("QUAN_TRI");

            entity.HasIndex(e => e.TaiKhoan, "UQ__QUAN_TRI__D5B8C7F04FB8E6E8").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SAN_PHAM__3214EC27EB42C6E6");

            entity.ToTable("SAN_PHAM");

            entity.HasIndex(e => e.MaSanPham, "UQ__SAN_PHAM__FAC7442C109DFE29").IsUnique();
